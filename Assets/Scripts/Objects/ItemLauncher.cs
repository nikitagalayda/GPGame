...
public class ItemLauncher : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        spawnLocations = new float[9] {-4f, -3f, -2f, -1f, 0f, 1f, 2f, 3f, 4f};
    }
    ...
    private void SpawnRandomItem() {
        ...
        Instantiate(randItem, new Vector3(spawnLocations[randPos], gameObject.transform.position.y, 0), Quaternion.identity);
    }
}
